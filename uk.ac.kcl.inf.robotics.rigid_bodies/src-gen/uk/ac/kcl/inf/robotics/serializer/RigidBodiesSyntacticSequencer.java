...
public class RigidBodiesSyntacticSequencer extends AbstractSyntacticSequencer {

	protected RigidBodiesGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (RigidBodiesGrammarAccess) access;
	}
	
	@Override
	protected String getUnassignedRuleCallToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if(ruleCall.getRule() == grammarAccess.getREALRule())
