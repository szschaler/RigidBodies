...
public class ExternalLoadImpl extends SystemElementImpl implements ExternalLoad
{
  ...
  public Body getBody1()
  {
    if (body1 != null && body1.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RigidBodiesPackage.EXTERNAL_LOAD__BODY1, oldBody1, body1));
      }
    }
    return body1;
  }
  ...
  public void setBody1(Body newBody1)
  {
    ...
    body1 = newBody1;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RigidBodiesPackage.EXTERNAL_LOAD__BODY1, oldBody1, body1));
  }
  ...
  public Body getBody2()
  {
    if (body2 != null && body2.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, RigidBodiesPackage.EXTERNAL_LOAD__BODY2, oldBody2, body2));
      }
    }
    return body2;
  }
  ...
  public void setBody2(Body newBody2)
  {
    ...
    body2 = newBody2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RigidBodiesPackage.EXTERNAL_LOAD__BODY2, oldBody2, body2));
  }
