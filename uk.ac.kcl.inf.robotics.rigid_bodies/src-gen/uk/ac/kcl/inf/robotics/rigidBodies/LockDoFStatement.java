 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.robotics.rigidBodies.LockDoFStatement#getJoint <em>Joint</em>}</li>
...
public interface LockDoFStatement extends ConfigurationStatement
{
   ...
   * @see #setJoint(Joint)
   * @see uk.ac.kcl.inf.robotics.rigidBodies.RigidBodiesPackage#getLockDoFStatement_Joint()
   * @model
   * @generated
   */
  Joint getJoint();
  ...
  /**
   * Sets the value of the '{@link uk.ac.kcl.inf.robotics.rigidBodies.LockDoFStatement#getJoint <em>Joint</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
