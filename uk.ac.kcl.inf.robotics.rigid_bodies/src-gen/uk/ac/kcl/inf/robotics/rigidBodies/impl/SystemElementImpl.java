...
public class SystemElementImpl extends MinimalEObjectImpl.Container implements SystemElement
{
  ...
  {
    return RigidBodiesPackage.Literals.SYSTEM_ELEMENT;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RigidBodiesPackage.SYSTEM_ELEMENT__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RigidBodiesPackage.SYSTEM_ELEMENT__NAME:
        return getName();
    }
