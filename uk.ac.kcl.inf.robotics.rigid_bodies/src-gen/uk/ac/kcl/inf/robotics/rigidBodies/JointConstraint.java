 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.robotics.rigidBodies.JointConstraint#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface JointConstraint extends SystemElement
{
  /**
   ...
   * @see #setName(String)
   * @see uk.ac.kcl.inf.robotics.rigidBodies.RigidBodiesPackage#getJointConstraint_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link uk.ac.kcl.inf.robotics.rigidBodies.JointConstraint#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
