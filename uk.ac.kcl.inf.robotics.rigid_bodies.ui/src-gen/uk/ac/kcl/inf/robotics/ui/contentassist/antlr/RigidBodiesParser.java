		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStateDefAccess().getInstancesAssignment_2(), "rule__StateDef__InstancesAssignment_2");
					put(grammarAccess.getStateDefAccess().getStatesAssignment_3(), "rule__StateDef__StatesAssignment_3");
