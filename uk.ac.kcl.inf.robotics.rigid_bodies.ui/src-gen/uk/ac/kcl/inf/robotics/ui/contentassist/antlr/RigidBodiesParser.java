		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBodyConstraintAccess().getGroup(), "rule__BodyConstraint__Group__0");
					...
					put(grammarAccess.getBodyReferenceAccess().getRefAssignment_3(), "rule__BodyReference__RefAssignment_3");
					...
					put(grammarAccess.getBodyConstraintAccess().getNameAssignment_1(), "rule__BodyConstraint__NameAssignment_1");
					put(grammarAccess.getBodyConstraintAccess().getTypeAssignment_3(), "rule__BodyConstraint__TypeAssignment_3");
					put(grammarAccess.getBodyConstraintAccess().getBody1Assignment_5(), "rule__BodyConstraint__Body1Assignment_5");
					put(grammarAccess.getBodyConstraintAccess().getRelTrans1Assignment_6(), "rule__BodyConstraint__RelTrans1Assignment_6");
					put(grammarAccess.getBodyConstraintAccess().getBody2Assignment_8(), "rule__BodyConstraint__Body2Assignment_8");
					put(grammarAccess.getBodyConstraintAccess().getRelTrans2Assignment_9(), "rule__BodyConstraint__RelTrans2Assignment_9");
