		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJointAccess().getRelTrans1Assignment_6(), "rule__Joint__RelTrans1Assignment_6");
					put(grammarAccess.getJointAccess().getBody2Assignment_8(), "rule__Joint__Body2Assignment_8");
					put(grammarAccess.getJointAccess().getRelTrans2Assignment_9(), "rule__Joint__RelTrans2Assignment_9");
